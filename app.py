...
def get_person_count():
    ...
    return jsonify({"person_count": person_count, "area": area})
...
if __name__ == "__main__":
    detection_process = multiprocessing.Process(target=start_detection, args=(current_person_count, current_area))
